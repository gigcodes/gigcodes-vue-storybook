...
import { createComponent, createNotification } from './mount-component.js'
...
const toast = (message, options = defaultOptions) => push(createNotification(message, 'success', 'Success'), options)
...
const info = (message, title = 'Info', options = defaultOptions) =>
